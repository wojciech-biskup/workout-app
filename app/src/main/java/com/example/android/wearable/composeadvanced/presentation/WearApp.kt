...
import com.example.android.wearable.composeadvanced.data.WorkoutAppDatabase
...
import com.example.android.wearable.composeadvanced.presentation.ui.*
import com.example.android.wearable.composeadvanced.presentation.ui.LandingScreen
...
fun WearApp(
    ...
    val workoutAppDb = Room.databaseBuilder(
        ...
        WorkoutAppDatabase::class.java, "workout-app-database-v12"
