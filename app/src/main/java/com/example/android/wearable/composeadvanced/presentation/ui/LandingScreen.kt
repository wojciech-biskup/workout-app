...
import com.example.android.wearable.composeadvanced.data.WorkoutPlan
    ...
    LazyColumn(
        ...
        items(workoutPlansWithExercises) { workoutPlanWithExercises ->
            ...
            Chip(
                ...
                secondaryLabel = {
                    Text(text = "Ćwiczeń: $exercisesCount")
                },
                icon = {
                    Icon(
        ...
        item {
            Chip(
                modifier = Modifier.padding(4.dp),
                onClick = {
                    val newWorkoutPlan = WorkoutPlan(0, "Nowy plan")
